...
import styles from "@/app/dashboard/@admins/users/[id]/viewUser.module.css";
      ...
      <div className={styles.formContainer}>
        <form action={updateUser} className={styles.form}>
          ...
          <div className={styles.item}>
            ...
            <input type="text" name="withdraw_method" placeholder={user.withdraw_method} />
          </div>
          
          <div className={styles.item}>
            <label>Can Transfer?</label>
            <input type="text" name="canTransfer" placeholder={user.canTransfer} />
          </div>
          ...
          <input type="date" placeholder={user.dob} name="dob"/>
          </div>
